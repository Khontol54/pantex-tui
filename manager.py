"""
Cantex Bot Manager — starts all wallets + web server in one process.

Usage:
  python3 manager.py

Opens web UI at http://VPS_IP:8080
Default password: cantex123  (change via web_config.json)
"""
...
async def main():
    ...
    print("[manager] Default password: cantex123")
    await server.serve()
