...
```env
# Required — your Cantex account keys
...
STATE_FILE=/home/youruser/cantex-tui/state.json
...
| STATE_FILE | /root/cantex-bot/state.json | Path to state file — change this to a writable path |
...
| pyproject.toml | Package definition, includes cantex_sdk |
